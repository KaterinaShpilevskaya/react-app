import { CardsListType, LikeStatus, SetLikeStatusPayload } from './../../Constants/@types';
...
export const { setSelectedPost, setSelectedPostModalVisible, setLikeStatus, setSavedPosts, getPosts, setPosts } = postsSlice.actions;
